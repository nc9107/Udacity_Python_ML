...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        if results_dic[key][2] == 1:
             ...
             #Checks if it is the correct breed. Happens when pet image is a dog and the classifies as a dog 
    ...
    # Calculating the percentagesto be entereed in stats dictionary 
